const styles = {
  ...
  heading2: 'text-[20px] font-ttruns font-semibold text-white',
  heading3: 'text-[14px] font-ttruns font-semibold text-white',
  ...
  buttoncta1: 'text-[16px] font-inter font-semibold text-white',
  buttoncta2: 'text-[16px] font-ttruns font-semibold text-white',

...
import { homeHeader, stake, reward,arrow, award2 } from '../../assets/images'
  ...
  return (
    <>
      ...
      <div className={`${styles.marginX} ${styles.marginY}  bg-white rounded-xl shadow`}>
        ...
        >  
            <div className={`${styles.caption1} !text-black px-4 py-2 rounded-full bg-purple-100 `}>Total <span className='font-bold'>300,000</span></div>
        ...
        <div className="button rounded-full bg-purple-100 pl-8 mb-4 -mt-3.5">
    <h1 className={`${styles.heading2} !text-black flex justify-between`}> <span className='my-auto px-4 flex flex-col'><p className={`${styles.caption2} !text-black`}>Wager Earned</p><p>12,470</p></span> <span className='-mr-2 bg-black text-white rounded-full px-8 py-4'>WITHDRAW</span> </h1>
  </div>
        </div>
...
<div className="button rounded-full bg-yellow px-8 py-3 my-auto mb-4">
    <h1 className={`${styles.heading2} !text-black flex justify-center`}> <span className='my-auto'>INVITE YOUR FRIEND</span> <span className='-mr-2 '><img src={arrow} alt="" className='h-8 w-8 my-auto' /></span> </h1>
  </div>
  <div className="button rounded-full bg-black px-8 py-3 my-auto mb-4">
